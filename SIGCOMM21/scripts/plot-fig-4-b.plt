...
set output "../outputs/Fig-4-b.pdf"
...
plot \
  "../processedData/routerDistr-lat.txt" using 1:3 title "Internet routers" with lines lc rgb "blue" lw 2 lt 2 dashtype "..", \
  "../processedData/ixpDistr-lat.txt" using 1:3 title "IXPs" with lines lc rgb "#7D3C98" lw 2 lt 3 dashtype "_", \
  "../processedData/dnsDistr-lat.txt" using 1:(($3*100)) title "DNS root servers" with lines lc rgb "#FF7F11" lw 2 dashtype "--" ,\
