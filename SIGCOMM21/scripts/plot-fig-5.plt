...
set output "../outputs/Fig-5.pdf"
set ylabel "CDF" font ",10" 
set xlabel "Length (km)" font ",10" #offset 2
...
plot \
  "../processedData/intertubes-lengths-cdf.txt" using 1:3 title "US long-haul (land)" with lines lc rgb "red" lw 2 lt 2 , \
  "../processedData/submarine-cable-lengths-cdf.txt" using 1:3 title "Submarine cables" with lines lc rgb "blue" lw 2 lt 2 dashtype "_"
