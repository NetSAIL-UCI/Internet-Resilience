...
set output "../outputs/Fig-7-c.pdf"
...
plot \
  "../processedData/submarineCables/submarine-uniform-stats-150.txt" using 2:(($5*100)):(($6*100)) with yerrorbars title "Submarine" lc rgb "#196F3D"  lt 2 pointtype 3, \
  "../processedData/submarineCables/submarine-uniform-stats-150.txt" using 2:(($5*100)) with lines notitle lc rgb "#196F3D"  lt 2, \
  "../processedData/intertubes/intertubes-uniform-stats-150.txt" using 2:(($5*100)):(($6*100)) with yerrorbars title "Intertubes" lc rgb "blue" lt 2 pointtype 1 , \
  "../processedData/intertubes/intertubes-uniform-stats-150.txt" using 2:(($5*100)) with lines notitle lc rgb "blue", \
